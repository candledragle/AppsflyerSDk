...
final class e {
    ...
    static String ˊ(Context var0, long var1) {
        ...
        var10.append(ॱ(var0, var7));
        var3.append(var10.toString());

        try {
            long var16 = var0.getPackageManager().getPackageInfo(var0.getPackageName(), 0).firstInstallTime;
            String var6 = ˋ(18, '\u0000', 36).intern();
            SimpleDateFormat var15;
            (var15 = new SimpleDateFormat(var6, Locale.US)).setTimeZone(TimeZone.getTimeZone("UTC"));
        ...
        String var12 = var18;
        StringBuilder var13;
        (var13 = new StringBuilder(var12)).setCharAt(17, Integer.toString(Integer.parseInt(var14, 2), 16).charAt(0));
        var18 = var13.toString();
        var14 = var5.toString();
        var12 = var18;
        (var13 = new StringBuilder(var12)).setCharAt(27, Integer.toString(Integer.parseInt(var14, 2), 16).charAt(0));
    ...
    private static String ˎ(String var0) {
        ...
        if (!var0.contains(ˋ(1, '\u0000', 169).intern())) {
            ...
            StringBuilder var2;
            (var2 = new StringBuilder()).append(var4[var1 - 1]).append(ˋ(1, '\u0000', 169).intern());
            int var3 = 1;
    ...
    private static String ॱ(Context param0, String param1) {
        // $FF: Couldn't be decompiled
    }
