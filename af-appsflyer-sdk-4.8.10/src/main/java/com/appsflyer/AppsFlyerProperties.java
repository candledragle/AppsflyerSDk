...
public class AppsFlyerProperties {
    ...
    void setLogLevel(AFLogger.LogLevel logLevel) {
        set(LOG_LEVEL, logLevel.getLevel());
    }

    int getLogLevel() {
      return getInt(LOG_LEVEL, AFLogger.LogLevel.NONE.getLevel());
    }
    ...
    void enableLogOutput(boolean shouldEnable){
    ...
    public void loadProperties(Context context) {
        ...
        if (propertiesString != null) {
            ...
            try {
                ...
                AFLogger.afErrorLog("Failed loading properties", jex);
            }
