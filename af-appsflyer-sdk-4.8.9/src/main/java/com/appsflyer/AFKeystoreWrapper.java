...
class AFKeystoreWrapper {
    ...
    private void initKeyStore() {
        ...
        try {
            ...
            AFLogger.afErrorLog("Couldn't load keystore instance of type: "+PROVIDER_ANDROID_KEY_STORE,e);
        }
    }
        ...
        synchronized (lock) {
            if (keystore != null) {
                try {
                    ...
                    AFLogger.afErrorLog("Couldn't list KeyStore Aliases: " + e.getClass().getName(),e);
                }
            }
        }
        return isDataExists;
        ...
        try {
            ...
            synchronized (lock) {
                if (!keystore.containsAlias(alias)) {
                    ...
                    AFLogger.afInfoLog("Alias already exists: " + alias);
                }
            }
        } catch (Throwable e) {
            AFLogger.afErrorLog("Exception " + e.getMessage() + " occurred",e);
        }
    }
                ...
                try {
                    ...
                    while (aliases.hasMoreElements()) {
                        ...
                        if (isAppsFlyerPrefix(alias)) {
                            AFLogger.afInfoLog("Found AF key. Removing: " + alias);
                            keystore.deleteEntry(alias);
                        }
                    }
                } catch (Throwable t) {
