...
/**
 * @author  by shacharaharon on 14/03/2017.
 */
...
public interface Constants {
    ...
    static final String BASE_URL_APP_APPSFLYER_COM = "https://app.%s";
    ...
    static final String URL_CAMPAIGN = "c";
    ...
    static final String APPSFLYER_DEFAULT_APP_DOMAIN = "app.%s";
